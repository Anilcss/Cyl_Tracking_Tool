...
public class Cylmasters {
    ...
    public void insert_Cyl_masters(ArrayList<String> cylmaster) {
        ...
        try {
            ...
            String sql = "INSERT INTO cylmaster (cylno, cyltype, cylmake, cylDOM, cylDOT) VALUES(?,?,?,?,?)";
            ...
            System.out.println("Error: "+LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")) +"==>" + e.getMessage());
        } finally {

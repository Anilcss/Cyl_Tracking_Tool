...
<form action="initialstock" method="post">
  <div class="header">
    <h1>Initial Stock in Yard</h1>
  ...
  <hr>
      ...
      %>
         ...
         while (rs.next() && rs.getString("custcompname") != null) {
          ...
          %>
					<option selected value="<%=8%>"><%="Rukmini(Own company)"%></option>
					<% } %>
				</select>
				<%
        rs.close();
      ...
      %>
			...
			<div class="form-group" style="padding-left: 20px">
				<input type="date" value="<%=formattedDate.toString() %>" id="incoming_date"
